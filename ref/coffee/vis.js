  ...
  Network = function() {
    ...
    nodeCounts = function(nodes, attr) {
      ...
      nodes.forEach(function(d) {
        var _name;
        if (counts[_name = d[attr]] == null) counts[_name] = 0;
    ...
    sortedArtists = function(nodes, links) {
      ...
      if (sort === "links") {
        ...
        links.forEach(function(l) {
          var _name, _name2;
          if (counts[_name = l.source.artist] == null) counts[_name] = 0;
          counts[l.source.artist] += 1;
          if (counts[_name2 = l.target.artist] == null) counts[_name2] = 0;
    ...
    hideDetails = function(d, i) {
      ...
      if (link) return link.attr("stroke", "#ddd").attr("stroke-opacity", 0.8);
    };
    return network;
  };
